        ...
        <div className="flex gap-2 items-center w-full md:w-auto">
          <div className="flex bg-slate-100 p-1 rounded-lg flex-1 md:flex-none">
            <button 
              ...
              className={`flex-1 md:flex-none px-4 py-2 rounded-md text-sm font-medium transition-all whitespace-nowrap ${activeTab === 'overview' ? 'bg-white shadow-sm text-slate-900' : 'text-slate-500 hover:text-slate-700'}`}
            >
              Visão Geral
            </button>
            <button 
              onClick={() => setActiveTab('analysis')}
              className={`flex-1 md:flex-none px-4 py-2 rounded-md text-sm font-medium transition-all whitespace-nowrap ${activeTab === 'analysis' ? 'bg-white shadow-sm text-slate-900' : 'text-slate-500 hover:text-slate-700'}`}
            >
              Análise Detalhada
            </button>
          </div>
          ...
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 bg-indigo-50 text-indigo-600 rounded-lg hover:bg-indigo-100 transition-colors font-medium text-sm h-10 shrink-0"
            title="Exportar CSV"
          >
            <Download size={18} />
